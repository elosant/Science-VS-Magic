...
entityPool.globalEntityCount = 0

function entityPool.createEntity(...) -- Accepts a tuple of components that are registered to on construction.
	entityPool.globalEntityCount = entityPool.globalEntityCount + 1

	-- A GUID is used as the entityId instead of global count, the pool need not be contiguous (since entities can be deleted).
